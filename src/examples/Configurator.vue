<template>
  <div class="fixed-plugin">
    <a
      ...
      @click="toggle"
    >
    <i class="py-2 fa fa-cog">Config</i>
    </a>
      ...
      <div class="pt-0 card-body pt-sm-3">
        ...
        <a href="#" class="switch-trigger background-color">
          <div
            ...
            :class="main.isRTL ? 'text-end' : ' text-start'"
          >
            <span
        ...
        <div class="form-check form-switch ps-0">
          <input
            ...
            :class="main.isRTL ? 'float-end  me-auto' : ' ms-auto'"
            type="checkbox"
            id="navbarFixed"
            :checked="main.isNavFixed"
...
export default defineComponent({
  ...
  setup(){
    ...
    // const { isRTL, isNavFixed, color} = storeToRefs(main);

      // access the actions in useMain store
    // const {  navbarMinimize, toggleSidebarColor } = main;
  ...
  methods: {
    sidebarColor(color = "success") {
      ...
      color = `card-background-mask-${color}`;
    },
